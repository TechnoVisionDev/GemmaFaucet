          ...
          <div className="w-full max-w-2xl px-6 sm:px-4 p-1 pt-0">
            ...
            <div className="flex justify-center mt-1">
              <div className="text-left text-gray-300 space-y-1 mb-4 text-base leading-normal">
                <p className="flex items-center text-xl">
                  ...
                  <span>
                    You can claim <b>{process.env.NEXT_PUBLIC_FAUCET_REWARD} GEMMA</b> every hour.
                  </span>
                </p>
                <p className="flex items-center text-xl">
                  <span className="mr-2">🏦</span>
                  <span>
                    Faucet Balance: <b>{faucetBalance} GEMMA</b>
                  </span>
                </p>
                <p className="flex items-center text-xl">
                  <span className="mr-2 text-xl">💜</span>
                  <span>
                    <a href="/donate" className="underline text-[#ba93f5] hover:text-[#ba93f5]">
                      Donate
                    </a>{' '}
            ...
            <div className="mt-6">
              <div className="flex items-center space-x-2 mb-2">
                <input
                  type="text"
                  placeholder="Enter your GEMMA address"
                  value={address}
                ...
                <button
                  ...
                  className="bg-[#9356f0] text-white px-4 h-14 rounded disabled:opacity-50 hover:bg-[#9e64f5] flex items-center justify-center"
                >
